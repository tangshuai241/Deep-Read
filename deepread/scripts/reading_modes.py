...
READING_MODES = {
    ...
    "literature_experience": {
        "name": "经典文学导读",
        "desc": "情节还原→人物洞察→主旨时代→个人共鸣，适合《红岩》《水浒传》《红楼梦》等经典文学",
        "target": "逐章把握情节、理解人物性格、提炼主旨、联系自身",
        "sections": ["情节还原", "人物洞察", "主旨与时代", "我的共鸣", "待探索"],
        "trial": True,
        "suggest_patterns": ["小说", "散文", "传记", "文学", "故事",
                            ...
                            "鲁迅", "老舍", "巴金", "茅盾"],
        "stage_notes": (
            "导读强度三档：轻读(情节+感受)/标准(情节+人物+主旨)/深读(完整五阶段)。\n"
            "章节类型识别：情节章/人物章/背景章/散文章，追问侧重不同。\n"
            "核心原则：先拉一把，再推一把，最后才代劳。不强求每章都有个人共鸣。\n"
            "详见 references/dialogue-flow-literature.md"
        ),
        "notable_checks": {
            "plot": "章节情节概述（关键事件用自己的话讲清楚）",
            "character": "人物分析（行为→性格→动机，至少分析1个角色）",
            "theme": "主旨提炼或社会背景分析",
            "resonance": "个人感受或共鸣",
        },
    },
...
MODE_QUICK_NAMES = {
    ...
    "散文": "literature_experience", "名著": "literature_experience",
    "经典": "literature_experience",
}
